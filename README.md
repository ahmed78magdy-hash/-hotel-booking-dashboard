...
Data Pipeline
Raw CSV (119,390 rows) imported into MySQL via LOAD DATA LOCAL INFILE
Cleaned in SQL: removed 1 exact duplicate, 1 negative-price row, 180 zero-guest bookings, and 1 extreme price outlier — 119,207 clean rows remain
Connected live to Python (Jupyter) via mysql-connector-python for analysis
Exported to hotel_booking.csv and rebuilt as this Streamlit app
Key Findings
